      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ng-template #sectionLoader>
          <div class="flex justify-center items-center py-16">
            <div class="relative">
              <div class="w-14 h-14 rounded-full border-4 border-blue-200 dark:border-gray-600"></div>
              <div class="w-14 h-14 rounded-full border-4 border-blue-600 border-t-transparent animate-spin absolute top-0 left-0"></div>
            </div>
          </div>
        </ng-template>

        <!-- Projects Grid -->
        <ng-container *ngIf="!isLoadingProjects; else sectionLoader">
